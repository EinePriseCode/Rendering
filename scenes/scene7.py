...
cam1 = Camera(16 / 9, 100, 1, max_bounce_depth=2, samples_per_pixel=64)
...
s6 = Sphere(Vector(-3.5, -2, -3), .5, material=SpecularMaterial(Vector(1, .84, 0), 0))
s7 = Sphere(Vector(3.5, -3, -3), .5, material=SpecularMaterial(Vector(.85, .85, .85), 0))
s8 = Sphere(Vector(1.5, -2, -5), .5, material=SpecularMaterial(Vector(.75, .54, .44), .4))

s9 = Sphere(Vector(-3.5, -2, -3), .5, material=Transmissive(1.5))
s10 = Sphere(Vector(3.5, -3, -3), .5, material=Transmissive(1.5))
s11 = Sphere(Vector(1.5, -2, -5), .5, material=Transmissive(1.5))
