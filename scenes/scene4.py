...
s5 = Sphere(Vector(-5.5, -4, -5.5), 1, material=DiffuseMaterial(Vector(1, .84, 0)))
s6 = Sphere(Vector(-3, -3, -7.8), 2, material=DiffuseMaterial(Vector(.85, .85, .85)))
s7 = Sphere(Vector(4, -4, -4.9), 1, material=DiffuseMaterial(Vector(.75, .54, .44)))

s8 = Sphere(Vector(0, -2, -3.8), 2.8, material=DiffuseMaterial(Vector(0, 0, 0)))
s9 = Sphere(Vector(0, -2, -3.8), 2.6, material=DiffuseMaterial(Vector(0, 0, 0)))
s10 = Sphere(Vector(-13, 3, -18), 8, material=DiffuseMaterial(Vector(0, 0, 0)))
